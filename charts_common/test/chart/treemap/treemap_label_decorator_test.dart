...
//       verticalSliceWidth: textStyle?.fontSize?.toDouble() ?? 0,
//       baseline: textStyle?.fontSize?.toDouble() ?? 0);
...
//       final captured =
//           verify(canvas.drawText(captureAny, captureAny, captureAny, rotation: _90DegreeClockwise)).captured;
//       expect(captured, hasLength(3));
//       expect(captured[0].text, 'Region');
...
//       decorator.decorate(renderElement, canvas, graphicsFactory,
//           drawBounds: drawBounds, animationPercent: 1.0, renderMultiline: renderElement.isLeaf);
...
//       decorator.decorate(renderElement, canvas, graphicsFactory,
//           drawBounds: drawBounds, animationPercent: 1.0, rtl: true, renderMultiline: renderElement.isLeaf);
...
//       decorator.decorate(renderElement, canvas, graphicsFactory,
//           drawBounds: drawBounds, animationPercent: 1.0, renderVertically: true, renderMultiline: renderElement.isLeaf);
...
//       // Second line.
//       expect(
//           captured[4], equals(drawBounds.right - decorator.labelPadding - 2 * _defaultFontSize - _defaultLineHeight));
